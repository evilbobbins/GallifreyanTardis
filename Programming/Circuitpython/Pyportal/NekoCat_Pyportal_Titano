...
# Updated to scale on the PyPortal Titano
#
#
...
if USE_TOUCH_OVERLAY:
    ...
    ts = adafruit_touchscreen.Touchscreen(
        ...
        size=(480, 320), # updated to Titano pixel size 
    )
...
# updated to Titano pixel size 
background_bitmap = displayio.Bitmap(30, 20, 1)
